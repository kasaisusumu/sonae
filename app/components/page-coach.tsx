    ...
    steps: [
      {
        ...
        title: "これは“たたき台”です",
        body: "予定から自動で用意した準備リスト。ここから、あなたに合わせて直していきます。用意できた項目は左のチェックを付けるだけ。",
      },
      {
        sel: '[data-coach="dictation"]',
        title: "まずは「話して作る」が早い",
        body: "スマホのキーボードのマイクキーで、持ち物や準備を思いつくまま話すだけ。AI が枠に振り分けて追加します。ゼロから打つより速いです。",
      },
      {
